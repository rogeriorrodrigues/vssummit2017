...
extern void *mono_aot_module_FaceEmotionRecognitioniOS_info;
...
extern void *mono_aot_module_FaceEmotionRecognition_info;
...
extern void *mono_aot_module_Microsoft_ProjectOxford_Emotion_info;
...
{
	mono_aot_register_module (mono_aot_module_FaceEmotionRecognitioniOS_info);
	...
	mono_aot_register_module (mono_aot_module_FaceEmotionRecognition_info);
	...
	mono_aot_register_module (mono_aot_module_Microsoft_ProjectOxford_Emotion_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "FaceEmotionRecognitioniOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
